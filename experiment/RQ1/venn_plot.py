...
venn.get_label_by_id('A').set_fontsize(20)  # Label for the first set
venn.get_label_by_id('B').set_fontsize(20)  # Label for the second set
...
plt.text(-0.6, 0.25, 'Unique Leaks\nBefore Debloating', fontsize=20, ha='center')
plt.text(0.6, 0.25, 'Unique Leaks\nAfter Debloating', fontsize=20, ha='center')
...
# Save as EPS file
plt.title('Venn Diagram of Leak Comparison', fontsize=20)
