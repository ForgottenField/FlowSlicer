...
public class HashHelper {
    ...
    public static String hash(final File file, final String algorithm) {
        if (file.isDirectory()) {
            System.out.println("File for hash creation is a directory (" + file.getAbsolutePath()
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    System.out.println("Could not close a file's input stream: " + file.getAbsolutePath());
                    return null;
                }
            }
        } catch (final FileNotFoundException | NoSuchAlgorithmException e) {
            System.out.println("Could not find file for hash creation: " + file.getAbsolutePath());
            return null;
        }
    }
